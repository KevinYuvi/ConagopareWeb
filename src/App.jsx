...
function Home() {
  return (
    <>
      <HeroPortada />
      <SeccionImagen id="objetivo" background={fondo1} title="Nuestro Objetivo"
      ...
      <SeccionImagen id="datos" background={fondo2} title="Datos Rurales"
      ...
      <SeccionImagen id="porque" background={fondo3} title="¿Por qué lo hicimos?"
      ...
      <SeccionImagen id="accion" background={fondo4} title="Periodismo de datos y comunicación transmedia"
