...
export default function Difunde() {
    ...
    return (
      <div className="bg-gray-100 text-gray-900 py-5 px-6">
        <h2 className="text-3xl font-heading font-bold text-center mb-2">Material de Difusión</h2>
        <p className="text-center text-base max-w-3xl mx-auto mb-6 pr-10 pl-10">Explora, comparte y sé parte del cambio.</p>
