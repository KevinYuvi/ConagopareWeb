...
const PaginaProblemas: React.FC = () => {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
      <h1 className="text-3xl font-heading font-bold text-center mb-4">Problemas Rurales en el Ecuador</h1>
      ...
      <section style={{ marginTop: '3rem' }}>
        <h1 className="text-3xl font-heading font-bold text-center mb-4">Problemas por Región</h1>
        <select
      ...
      <section style={{ marginTop: '3rem' }}>
        <h1 className="text-3xl font-heading font-bold text-center mb-4">Problemas por Provincia</h1>
        <select
